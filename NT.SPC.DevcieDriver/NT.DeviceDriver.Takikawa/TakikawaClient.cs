...
{
    public class TakikawaClient : IDeviceDriver
    {
        ...
        #region 字段、属性与构造方法
        private readonly string _driverName = "Takikawa Client";
        /// <summary>
        /// 配置文件
        /// </summary>
        ...
        /// 配置文件
        /// </summary>
        private string _defaultConfigFile = "Resources\\DeviceDriver\\Default\\Takikawa-Client.json";
        /// <summary>
        /// 配置文件
        /// </summary>
        ...
        /// BateCom 客户端
        /// </summary>
        private TakikawaCom _takikawaCom = null;
        /// <summary>
        /// 采集标志
        /// </summary>
        ...
        {
            if (this._takikawaCom != null)
            {
                this._takikawaCom.Close();
                this._takikawaCom.Dispose();
                this._takikawaCom = null;
            }
            _isConnected = false;
        ...
        private void Connect(ConnectConfig connectConfig)
        {
            ...
            if (this._takikawaCom == null)
            {
                this._takikawaCom = new TakikawaCom();
                SerialInit(_takikawaCom, connectConfig);
        ...
        private bool ReadDataFromAddress(AddressConfig address, out object value, out string errorMessage)
        {
            ...
            {
                case "short":
                    OperateResult<short> shortResult = _takikawaCom.ReadShort(address.SendChar);
                    ...
                    break;
                case "float":
                    OperateResult<float> floatResult = _takikawaCom.ReadFloats(address.SendChar, address.MillLen);
        ...
        /// <param name="connectConfig"></param>
        private void SerialInit(TakikawaCom modbus, ConnectConfig connectConfig)
        {
