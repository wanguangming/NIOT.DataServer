...
namespace NT.DeviceDriver.Modbus
{
    ...
    /// Modbus-TCP客户端
    /// </summary>
    public class ModbusTcpClient : IDeviceDriver
    {
        ...
        #region 字段、属性与构造方法
        private readonly string _driverName = "Modbus Tcp Client";
        /// <summary>
        /// 配置文件
        /// </summary>
        ...
        /// 配置文件
        /// </summary>
        private string _defaultConfigFile = "Resources\\DeviceDriver\\Default\\Modbus-TCP-Client.json";
        /// <summary>
        /// 配置文件
        /// </summary>
        ...
        private void Connect(ConnectConfig connectConfig)
        {
            ...
            if (this._modbus == null)
            {
                this._modbus = new ModbusTcpNet(connectConfig.Host, connectConfig.Port, connectConfig.SlaveID);
